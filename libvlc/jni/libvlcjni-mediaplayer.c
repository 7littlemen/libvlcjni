...
void
Java_org_videolan_libvlc_MediaPlayer_nativeSetVideoAdjustBool(JNIEnv *env,
                                                              jobject thiz,
                                                              jint option,
                                                              jboolean value)
{
    ...
    /* Enable / Disable adjust filter */
    libvlc_video_set_adjust_int(p_obj->u.p_mp,
                                (unsigned) option,
                                value ? 1 : 0);
}

jboolean
Java_org_videolan_libvlc_MediaPlayer_nativeGetVideoAdjustBool(JNIEnv *env,
                                                              jobject thiz,
                                                              jint option)
{
    vlcjni_object *p_obj = VLCJniObject_getInstance(env, thiz);
    ...
    return libvlc_video_get_adjust_int(p_obj->u.p_mp,
                                       (unsigned) option) != 0;
}

void
Java_org_videolan_libvlc_MediaPlayer_nativeSetVideoAdjustFloat(JNIEnv *env,
                                                               jobject thiz,
                                                               jint option,
                                                               jfloat value)
{
    ...
    libvlc_video_set_adjust_float(p_obj->u.p_mp,
                                  (unsigned) option,
                                  (float) value);
}

jfloat
Java_org_videolan_libvlc_MediaPlayer_nativeGetVideoAdjustFloat(JNIEnv *env,
                                                               jobject thiz,
                                                               jint option)
{
    vlcjni_object *p_obj = VLCJniObject_getInstance(env, thiz);
    ...
    return (jfloat) libvlc_video_get_adjust_float(p_obj->u.p_mp,
                                                  (unsigned) option);
}
// --- END NEW JNI METHODS ---
