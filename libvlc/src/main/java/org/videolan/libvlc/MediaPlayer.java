...
public class MediaPlayer extends VLCObject<MediaPlayer.Event> {
    ...
    public static final class VideoAdjustOption {
...
//        public static final int ChapterChanged      = 0x11d;
        ...
        /**
         * Snapshot file path returned by libVLC when {@link #SnapshotTaken} is fired.
         */
        @Nullable
    ...
    public void setVideoAdjustEnabled(boolean enabled) {
        nativeSetVideoAdjustBool(VideoAdjustOption.Enable, enabled);
    }
    public boolean isVideoAdjustEnabled() {
        return nativeGetVideoAdjustBool(VideoAdjustOption.Enable);
    }

    public void setVideoContrast(float v) { nativeSetVideoAdjustFloat(VideoAdjustOption.Contrast, v); }
    public float getVideoContrast() { return nativeGetVideoAdjustFloat(VideoAdjustOption.Contrast); }

    public void setVideoBrightness(float v) { nativeSetVideoAdjustFloat(VideoAdjustOption.Brightness, v); }
    public float getVideoBrightness() { return nativeGetVideoAdjustFloat(VideoAdjustOption.Brightness); }

    public void setVideoHue(float v) { nativeSetVideoAdjustFloat(VideoAdjustOption.Hue, v); }
    public float getVideoHue() { return nativeGetVideoAdjustFloat(VideoAdjustOption.Hue); }

    public void setVideoSaturation(float v) { nativeSetVideoAdjustFloat(VideoAdjustOption.Saturation, v); }
    public float getVideoSaturation() { return nativeGetVideoAdjustFloat(VideoAdjustOption.Saturation); }

    public void setVideoGamma(float v) { nativeSetVideoAdjustFloat(VideoAdjustOption.Gamma, v); }
    public float getVideoGamma() { return nativeGetVideoAdjustFloat(VideoAdjustOption.Gamma); }
    ...
    protected synchronized Event onEventNative(int eventType, long arg1, long arg2, float argf1, @Nullable String args1) {
        switch (eventType) {
            ...
            case Event.SnapshotTaken:
                return new Event(eventType, 0, args1);
            case Event.ESAdded:
    ...
    private native void nativeSetVideoAdjustFloat(int option, float value);
    private native float nativeGetVideoAdjustFloat(int option);
